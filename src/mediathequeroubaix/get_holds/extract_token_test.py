...
def test_ok() -> None:
    html = """
        <div class="panel-body">
            <input type="hidden" id="my_holds" value="abc" />
        </div>
    """
...
def test_empty_token() -> None:
    html = """
        <div class="panel-body">
            <input type="hidden" id="my_holds" value="" />
        </div>
    """
...
def test_two_tokens() -> None:
    html = """
        <div class="panel-body">
            <input type="hidden" id="my_holds" value="first" />
            <input type="hidden" id="my_holds" value="another" />
        </div>
    """
...
def test_contain_equal() -> None:
    html = """
        <div class="panel-body">
            <input type="hidden" id="my_holds" value="b64str=" />
        </div>
    """
